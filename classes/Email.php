...
class Email {
    ...
    public function enviarConfirmacion(){
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = '80011d95437a5a';
        $mail->Password = '1cf70a008da22e';
        ...
        $contenido = '<html>';
        $contenido .= "<p>Hola <strong>" . $this->nombre . "</strong> Has Creado tu cuenta en UpTask, solo debes confirmarla en el siguiente enalce </p>";
